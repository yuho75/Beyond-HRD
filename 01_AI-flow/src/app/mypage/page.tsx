...
export default function MyPage() {
  return (
    <div className="font-body-md text-gray-900 min-h-screen bg-[#f8f9fa] flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-72 bg-[#131313] border-r border-gray-200 flex flex-col shrink-0">
          ...
          <div className="mt-auto p-8 border-t border-gray-200">
            <button className="flex items-center gap-3 text-gray-500 hover:text-red-400 transition-colors font-technical-sm text-sm cursor-pointer">
        ...
        <main className="flex-1 overflow-y-auto p-8 bg-[#f8f9fa]">
          <div className="max-w-5xl mx-auto flex flex-col gap-10">
            ...
            {/* Welcome Banner */}
            <section className="bg-white rounded-3xl p-10 border border-gray-200 relative overflow-hidden flex items-center justify-between">
              ...
              <div className="flex items-center gap-8 z-10">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 mb-6">반가워요, 학습자님!</h1>
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center justify-between text-[10px] font-technical-sm text-gray-500 uppercase tracking-widest">
                ...
                <section>
                  <div className="flex items-center gap-8 border-b border-gray-200 mb-8">
                    ...
                    <div className="ml-auto flex gap-2">
                      <span className="text-[10px] font-technical-sm text-gray-400 px-2 py-0.5 border border-gray-200 rounded">#STARTUP</span>
                      <span className="text-[10px] font-technical-sm text-gray-400 px-2 py-0.5 border border-gray-200 rounded">#TECH</span>
                    </div>
                  </div>
                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="border-b border-gray-200">
                          <th className="p-5 text-[10px] font-technical-sm text-gray-400 uppercase tracking-widest">Content Title</th>
                          <th className="p-5 text-[10px] font-technical-sm text-gray-400 uppercase tracking-widest">Type</th>
                          <th className="p-5 text-[10px] font-technical-sm text-gray-400 uppercase tracking-widest">Credits</th>
                          <th className="p-5 text-[10px] font-technical-sm text-gray-400 uppercase tracking-widest">Date</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
              ...
              <div className="w-full lg:w-80 shrink-0 flex flex-col gap-8">
                <div className="bg-white border border-gray-200 rounded-3xl p-8 relative overflow-hidden">
                  <div className="flex items-center justify-between mb-10">
                    <h3 className="font-technical-sm text-xs uppercase tracking-widest text-gray-600">Growth Report</h3>
                  ...
                  <div className="flex items-end justify-between mb-8">
                    <div>
                      <p className="text-[10px] text-gray-400 font-technical-sm uppercase tracking-widest mb-1">Weekly Summary</p>
                      <p className="text-xs text-gray-600">Total Learning Time</p>
                    </div>
                    <div className="text-right">
                       <span className="text-3xl font-bold text-gray-900">4.2</span> <span className="text-xs text-gray-400 uppercase">hrs</span>
                    </div>
                  </div>
                ...
                <div className="bg-white border border-gray-200 rounded-3xl p-8">
                  <h3 className="font-technical-sm text-[10px] uppercase tracking-widest text-gray-400 mb-8">Account Status</h3>
                  <div className="flex flex-col gap-6">
                    ...
                    {[
                      ...
                      <button key={item} className="flex items-center justify-between text-xs text-gray-600 hover:text-gray-900 transition-all cursor-pointer group">
                        {item}
                        <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-gray-900 transition-all" />
                      </button>
                    ))}
                  </div>
                </div>
      ...
      {/* Footer */}
      <footer className="w-full bg-[#f8f9fa] border-t border-gray-200 px-12 py-8 flex items-center justify-between">
        <div className="flex flex-col gap-1">
          <span className="font-bold text-gray-900 text-lg tracking-tight">A-Zip</span>
          <p className="text-[10px] text-gray-400 uppercase tracking-widest">© 2024 A-ZIP. All rights reserved.</p>
        </div>
        <div className="flex gap-8 text-[10px] font-technical-sm text-gray-500 uppercase tracking-widest">
