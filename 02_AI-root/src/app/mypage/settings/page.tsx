      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-10 bg-[#0d0d0d]">
          <div className="max-w-4xl mx-auto flex flex-col gap-10">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">계정 및 구독 관리</h1>
              <p className="text-gray-500 text-sm">멤버십 상태를 확인하고 개인 설정을 변경할 수 있습니다.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Membership Status */}
              <section className="bg-[#1a1a1a] border border-white/5 rounded-3xl p-8 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-8">
                    <CreditCard className="w-5 h-5 text-[#c5b3f9]" />
                    <h3 className="text-sm font-bold text-white uppercase tracking-widest">Membership Plan</h3>
                  </div>
                  <div className="bg-black/40 border border-[#c5b3f9]/20 rounded-2xl p-6 mb-6">
                    ...
                    <p className="text-2xl font-bold text-white">₩ 9,900 / <span className="text-sm text-gray-500">month</span></p>
                  </div>
                </div>
                <button className="w-full py-3 bg-white/5 hover:bg-white/10 border border-white/5 rounded-xl text-xs font-bold transition-all">
                  멤버십 업그레이드 / 변경
                </button>
              </section>
              ...
              <section className="bg-[#1a1a1a] border border-white/5 rounded-3xl p-8 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <h3 className="text-sm font-bold text-white uppercase tracking-widest">Newsletter (Stibee)</h3>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-black/40 border border-white/5 rounded-2xl">
                    <div className="flex flex-col gap-1">
                      <p className="text-sm font-bold text-white">격주 뉴스레터 수신</p>
            ...
            <section className="bg-[#1a1a1a] border border-white/5 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-10">
                ...
                <h3 className="text-sm font-bold text-white uppercase tracking-widest">General Account Settings</h3>
              </div>
              ...
              <div className="flex flex-col gap-1">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-5 hover:bg-white/5 rounded-2xl transition-all cursor-pointer group border-b border-white/5 last:border-0">
              ...
              <div className="mt-10 pt-10 border-t border-white/5 flex items-center justify-between px-5">
                <div className="flex flex-col gap-1">
                  <p className="text-xs font-bold text-white">서비스 탈퇴</p>
