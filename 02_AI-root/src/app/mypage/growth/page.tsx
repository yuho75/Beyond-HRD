      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-10 bg-[#0d0d0d]">
          <div className="max-w-5xl mx-auto flex flex-col gap-10">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">성장 리포트</h1>
              <p className="text-gray-500 text-sm">당신의 학습 성취도와 목표 달성 현황을 분석합니다.</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Weekly Stats */}
              <div className="lg:col-span-2 bg-[#1a1a1a] border border-white/5 rounded-3xl p-8 flex flex-col">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-3">
                    <BarChart3 className="w-5 h-5 text-[#c5b3f9]" />
                    <h3 className="text-sm font-bold text-white uppercase tracking-widest">Weekly Learning Activity</h3>
                  </div>
                  <select className="bg-transparent text-[10px] text-gray-500 border border-white/10 rounded-lg px-2 py-1 outline-none">
                ...
                <div className="flex-1 flex items-end justify-between gap-4 h-48 mb-8 px-4">
                  {[
                    ...
                    <div key={i} className="flex-1 flex flex-col items-center gap-3 group">
                      <div className="w-full bg-white/5 rounded-t-lg relative overflow-hidden h-full min-h-[150px]">
                         <div 
                          className={`absolute bottom-0 left-0 right-0 rounded-t-lg transition-all duration-700 delay-${i*100} ${item.day === 'THU' ? 'bg-[#c5b3f9]' : 'bg-white/10 group-hover:bg-white/20'}`}
                ...
                <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/5">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-xl font-bold text-white">32m</span>
                  </div>
                  <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-8">
                <div className="bg-gradient-to-br from-[#1a1a1a] to-[#131313] border border-white/5 rounded-3xl p-8 flex flex-col items-center text-center">
                  ...
                  <h4 className="text-xl font-bold text-white mb-2">AI 기획자</h4>
            ...
            {/* Completed Courses */}
            <section>
              <h2 className="text-xl font-bold text-white mb-8 border-l-4 border-[#c5b3f9] pl-4">이수 완료 과정 (Course Progress)</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-6 flex items-center justify-between group hover:border-white/10 transition-all">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-white group-hover:text-[#c5b3f9] transition-colors">{item.title}</h4>
